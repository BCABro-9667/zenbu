  ...
  return (
    <div className="container py-12 md:py-20">
      <div className="prose lg:prose-lg max-w-none mx-auto">
        <h1>
          Refund and Returns Policy & Terms & Conditions
        </h1>
        
        <h2>Refund and Returns Policy</h2>
        <p>
          Please refer to the "Returns & Cancellations" section under our Terms & Conditions for details on our refund and return policies.
        </p>
        ...
        <ul>
            <li>These Terms & Conditions are governed by the laws of Faridabad.</li>
            <li>Any disputes arising shall be resolved exclusively in the courts of Faridabad.</li>
        </ul>
        ...
        <p>If you have any grievances, you may contact our Grievance Officer at:</p>
        <address className="not-italic">
          <strong>Name:</strong> Kamal Puri<br />
          <strong>Email:</strong> kamalkumarpuri@gmail.com<br />
          <strong>Phone:</strong> +91 98101 38219<br />
          <strong>Address:</strong> Plot No. 89, Sector-59, HSIIDC Industrial Estate, Faridabad, Haryana – 121 004
        </address>
